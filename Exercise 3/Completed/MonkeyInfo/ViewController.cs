...
namespace MonkeyInfo
{
    public partial class ViewController : UIViewController
    {
        ...
        void AnimateImage ()
        {
            View.RemoveConstraint(constMonkeyEdge);
            ...
            UIView.Animate(1.5, () => View.LayoutIfNeeded());
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            imgMonkey.AddGestureRecognizer(new UITapGestureRecognizer(AnimateImage));
        }
